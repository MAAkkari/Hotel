...
$hilton->info(); //affiche adresse nombre de chambres, chambres reservés et chambres libres.
$client2->Reservations(); //affiche les reservations du client
$hilton->Reservations(); //affiche le nombre de reservation, les chambres reserver et la personne qui les reserves
$hilton->statuts(); //affiche un tableau avec les chambres leurs prix si il y a du wifi ou pas et si elles sont reservé
